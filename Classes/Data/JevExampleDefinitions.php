...
final class JevExampleDefinitions
{
    ...
    private static function contactRouting(): array
    {
        return [
            ...
            'tryEn' => [
                'Write as a customer would, without naming a department — for example “Our last invoice lists the maintenance fee twice. Could you send a corrected one?” That is accounting.',
                'Or try “Since the update the editor no longer saves images.” (support), “Do you have an opening for a junior developer?” (jobs), “I am writing an article about TYPO3 agencies and would like to interview you.” (press), “What would a relaunch with 40 pages cost?” (sales).',
                'Nothing changes on the page: Jev decides when you press send. Below 60 % certainty the form’s default address gets the message. In this lab no mail leaves the server. The submission record in the backend shows what Jev decided and how sure it was.',
            ],
            'tryDe' => [
                'Schreiben Sie wie ein Kunde, ohne eine Abteilung zu nennen – zum Beispiel „Auf unserer letzten Rechnung steht die Wartungspauschale doppelt. Können Sie eine korrigierte schicken?“ Das ist die Buchhaltung.',
                'Oder: „Seit dem Update speichert der Editor keine Bilder mehr.“ (Support), „Haben Sie eine Stelle für einen Junior-Entwickler?“ (Jobs), „Ich schreibe einen Artikel über TYPO3-Agenturen und würde Sie gern interviewen.“ (Presse), „Was kostet ein Relaunch mit 40 Seiten?“ (Vertrieb).',
                'Auf der Seite ändert sich nichts: Jev entscheidet beim Absenden. Unter 60 % Sicherheit bekommt die Standardadresse des Formulars die Nachricht. In diesem Lab verlässt keine Mail den Server. Der Datensatz der Einsendung im Backend zeigt, was Jev entschieden hat und wie sicher es war.',
            ],
            'challengeEn' => 'Visitors rarely know which department they need, and keywords mislead: “invoice” turns up in sales questions, “error” in complaints about a bill. Jev reads what the message is about and names one of five departments, with a confidence. That confidence is the point: when Jev is not sure enough, a person sorts the message instead of the wrong team receiving it.',
            'challengeDe' => 'Besucher wissen selten, welche Abteilung sie brauchen, und Schlüsselwörter führen in die Irre: „Rechnung“ steht auch in Vertriebsfragen, „Fehler“ auch in Beschwerden über eine Abrechnung. Jev liest, worum es in der Nachricht geht, und nennt eine von fünf Abteilungen, samt Konfidenz. Genau darum geht es: Ist Jev nicht sicher genug, sortiert ein Mensch die Nachricht, statt dass sie beim falschen Team landet.',
    ...
    private static function supportTriage(): array
    {
        return [
            ...
            'tryEn' => [
                'Type into “What is the problem?”, then click outside the box. The form updates within a second.',
                'Describe a small bug: “Since the last update the footer shows the wrong year.” The question “How can we reproduce it?” appears.',
                'Make it serious by adding “And now the whole shop is down, we lose orders every hour.” Now the escalation note appears as well.',
                'Ask a question instead: “Do you also offer invoices in English?” Both stay hidden.',
            ],
            'tryDe' => [
                'Tippen Sie in „Was ist das Problem?“ und klicken Sie danach neben das Feld. Das Formular passt sich binnen einer Sekunde an.',
                'Beschreiben Sie einen kleinen Fehler: „Seit dem letzten Update zeigt die Fußzeile das falsche Jahr.“ Die Frage „Wie können wir es nachstellen?“ erscheint.',
                'Machen Sie es ernst: „Und jetzt ist der ganze Shop down, wir verlieren stündlich Bestellungen.“ Jetzt erscheint auch der Eskalationshinweis.',
                'Stellen Sie stattdessen eine Frage: „Gibt es die Rechnungen auch auf Englisch?“ Beides bleibt verborgen.',
            ],
            'challengeEn' => 'Whether a message reports a bug, and how bad it is, are judgements, not keywords. “Does it crash when I…?” is a question, and severity lives in the consequences, not in words like “urgent”. Jev answers both in one call: how likely it is a bug, and a score on a four-step severity scale. Each field has its own threshold, so an unsure answer leaves the form as it is.',
            'challengeDe' => 'Ob eine Nachricht einen Fehler meldet und wie schlimm er ist, sind Urteile, keine Schlüsselwörter. „Stürzt es ab, wenn ich …?“ ist eine Frage, und die Schwere steckt in den Folgen, nicht in Wörtern wie „dringend“. Jev beantwortet beides in einem Aufruf: wie wahrscheinlich es ein Fehler ist, und einen Wert auf einer vierstufigen Skala für die Schwere. Jedes Feld hat seine eigene Schwelle; eine unsichere Antwort lässt das Formular, wie es ist.',
                ...
                [
                    ...
                    'fields' => [
                        ...
                        self::field('html', 'escalation', 'Escalation', 'Eskalation', [
                            'textEn' => '<p><strong>This looks urgent.</strong> If your system is down right now, call us on +49 30 23125 999 instead of waiting for a reply to this form.</p>',
                            'textDe' => '<p><strong>Das klingt dringend.</strong> Wenn Ihr System gerade stillsteht, rufen Sie uns unter +49 30 23125 999 an, statt auf eine Antwort auf dieses Formular zu warten.</p>',
                        ]),
    ...
    private static function qualityGate(): array
    {
        return [
            ...
            'tryEn' => [
                'At first the send button is missing: an empty message has nothing to answer. Type into “Message”, then click outside the box.',
                'Write something real: “Can you migrate our TYPO3 11 site to version 14 before March, including our booking extension?” The send button appears.',
                'Try noise: “asdf” or “hi”. The button disappears again, and a note says what is missing.',
                'Borderline messages go through: the button only disappears when Jev is at least 70 % sure there is nothing to answer.',
            ],
            'tryDe' => [
                'Zuerst fehlt der Senden-Button: Eine leere Nachricht hat nichts zu beantworten. Tippen Sie in „Nachricht“ und klicken Sie danach neben das Feld.',
                'Schreiben Sie etwas Echtes: „Können Sie unsere TYPO3-11-Website bis März auf Version 14 heben, samt unserer Buchungs-Extension?“ Der Senden-Button erscheint.',
                'Versuchen Sie Rauschen: „asdf“ oder „hallo“. Der Button verschwindet wieder, und ein Hinweis sagt, was fehlt.',
                'Grenzfälle gehen durch: Der Button verschwindet nur, wenn Jev zu mindestens 70 % sicher ist, dass es nichts zu beantworten gibt.',
            ],
            'challengeEn' => 'A captcha proves you are human, not that your message says anything. Length limits reject short real questions and let long spam through. Jev rates how much there is to answer on a four-step scale — nothing, almost nothing, enough, plenty — and the gate closes only when that is confidently near nothing, because a false alarm costs a real enquiry.',
            'challengeDe' => 'Ein Captcha beweist, dass Sie ein Mensch sind, nicht dass Ihre Nachricht etwas sagt. Längengrenzen weisen kurze echte Fragen ab und lassen langen Spam durch. Jev bewertet auf einer vierstufigen Skala – nichts, fast nichts, genug, reichlich –, wie viel es zu beantworten gibt, und der Filter schließt nur, wenn das mit Sicherheit fast nichts ist, denn ein Fehlalarm kostet eine echte Anfrage.',
    ...
    private static function projectEnquiry(): array
    {
        return [
            ...
            'tryEn' => [
                'Describe the project in “What would you like built?” on step one, then continue. Step two depends on what you wrote.',
                'A large tender: “Public tender for relaunching a federal ministry portal: 40 sub-sites, accessibility audit, EU-wide procurement. The strategy papers we share must stay confidential.” Step two asks for the tender reference and the formal requirements, and offers a confidentiality agreement.',
                'A small job: “A one-page website for our bakery with opening hours and a map.” Step two asks none of that.',
            ],
            'tryDe' => [
                'Beschreiben Sie das Projekt auf Schritt eins unter „Was möchten Sie umsetzen lassen?“ und gehen Sie weiter. Schritt zwei hängt davon ab, was Sie geschrieben haben.',
                'Eine große Ausschreibung: „Öffentliche Ausschreibung für den Relaunch eines Ministeriumsportals: 40 Unterseiten, Barrierefreiheits-Audit, EU-weite Vergabe. Die Strategiepapiere, die wir teilen, sind vertraulich.“ Schritt zwei fragt nach dem Aktenzeichen und den formalen Anforderungen und bietet eine Vertraulichkeitsvereinbarung an.',
                'Ein kleiner Auftrag: „Eine einseitige Website für unsere Bäckerei mit Öffnungszeiten und Karte.“ Schritt zwei fragt nichts davon.',
            ],
            'challengeEn' => 'Whether an enquiry is a formal procurement, and whether it needs an NDA, is buried in how people describe it: “tender”, “ministry” and “EU-wide” against “bakery” and “one page”. Instead of a dropdown the visitor would first have to understand, Jev classifies the size and the need for confidentiality, and step two asks only what applies. When Jev is unsure, the extra questions stay hidden.',
            'challengeDe' => 'Ob eine Anfrage eine formale Vergabe ist und ob sie eine Vertraulichkeitsvereinbarung braucht, steckt in der Art, wie sie beschrieben wird: „Ausschreibung“, „Ministerium“ und „EU-weit“ gegen „Bäckerei“ und „eine Seite“. Statt einer Auswahlliste, die Besucher erst verstehen müssten, stuft Jev Größe und Vertraulichkeit ein, und Schritt zwei fragt nur, was zutrifft. Ist Jev unsicher, bleiben die Zusatzfragen verborgen.',
    ...
    private static function jobApplication(): array
    {
        return [
            ...
            'tryEn' => [
                ...
                'Just starting: “I am in my second semester of media design and have not worked in a studio yet.” Step two asks where you study and for a portfolio.',
                'Project management: “For six years I have coordinated web projects between clients, designers and developers.” Step two asks about leading a piece of work, without a portfolio.',
            ],
            'tryDe' => [
                'Schreiben Sie auf Schritt eins unter „Erzählen Sie von sich“ ein kurzes Anschreiben und gehen Sie weiter. Schritt zwei fragt, was sich daraus ergibt.',
                'Erfahren und remote: „Ich leite seit neun Jahren Backend-Teams, zuletzt für eine TYPO3-Plattform mit 30 Websites. Ich wohne in Graz und möchte vollständig remote arbeiten.“ Schritt zwei fragt nach einem Portfolio und nach einer Arbeit, die Sie geführt haben, und ergänzt einen Hinweis zur Remote-Arbeit.',
                'Am Anfang: „Ich bin im zweiten Semester Mediendesign und habe noch in keinem Studio gearbeitet.“ Schritt zwei fragt, wo Sie studieren, und nach einem Portfolio.',
                'Projektleitung: „Seit sechs Jahren koordiniere ich Webprojekte zwischen Kunden, Design und Entwicklung.“ Schritt zwei fragt nach einer Arbeit, die Sie geführt haben, ohne Portfolio.',
            ],
            'challengeEn' => 'Role, experience and the wish to work remotely are spread across free text, and each of them changes what a fair application form should ask. The decision matters to the applicant, so the bar is high: Jev must be at least 75 % sure of the role and the level of experience. Below that, the extra questions stay hidden and a person sorts the application.',
            'challengeDe' => 'Rolle, Erfahrung und der Wunsch nach Remote-Arbeit stecken verstreut im freien Text, und jedes davon ändert, was ein faires Bewerbungsformular fragen sollte. Für die Bewerberin oder den Bewerber steht etwas auf dem Spiel, darum liegt die Latte hoch: Jev muss sich bei Rolle und Erfahrungsstufe zu mindestens 75 % sicher sein. Darunter bleiben die Zusatzfragen verborgen, und ein Mensch sichtet die Bewerbung.',
