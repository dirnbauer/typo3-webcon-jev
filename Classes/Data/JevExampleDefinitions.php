...
final class JevExampleDefinitions
{
    ...
    private static function jobApplication(): array
    {
        return [
            ...
            'introEn' => 'Paste what you would put in a covering letter. Jev reads it for the role, the seniority and whether relocation is on the table, and step two asks only the questions that follow from those answers. Routing is confidence-gated: below the threshold the application goes to a human to sort, and the run log says so — which is the honest behaviour for a decision about somebody\'s career.',
            'introDe' => 'Fügen Sie ein, was Sie in ein Anschreiben schreiben würden. Jev liest daraus die Rolle, die Erfahrungsstufe und ob ein Umzug in Frage kommt, und Schritt zwei stellt nur die Fragen, die sich daraus ergeben. Die Weiterleitung ist konfidenzgesteuert: unterhalb der Schwelle geht die Bewerbung zur Sichtung an einen Menschen, und das Protokoll sagt das auch — das ehrliche Verhalten für eine Entscheidung über jemandes Laufbahn.',
            'moresteps' => true,
            'routingQuestion' => 'role',
            'decision' => [
                'identifier' => 'jev_job_application',
                'titleEn' => 'Application: role, seniority and mobility',
                'titleDe' => 'Bewerbung: Rolle, Erfahrungsstufe und Mobilität',
                'descriptionEn' => 'Reads a covering letter and answers which team it belongs to, how experienced the writer is, and whether they would relocate.',
                'descriptionDe' => 'Liest ein Anschreiben und beantwortet, zu welchem Team es gehört, wie erfahren die schreibende Person ist und ob sie umziehen würde.',
                ...
                'questions' => [
                    ...
                    [
                        'name' => 'would_relocate',
                        'type' => 'noul',
                        'en' => 'Does the letter say the writer is willing to move or is already nearby?',
                        'de' => 'Sagt das Anschreiben, dass die schreibende Person umziehen würde oder schon in der Nähe ist?',
                        'criteria' => [
                            ['id' => 'yes', 'en' => 'They name the city, say they would move, or already live in the region.', 'de' => 'Die Stadt wird genannt, ein Umzug angeboten oder die Region ist bereits der Wohnort.', 'outcome' => ''],
                            ['id' => 'no', 'en' => 'They ask for remote work, or say they cannot move.', 'de' => 'Es wird Remote-Arbeit erbeten oder gesagt, dass ein Umzug nicht möglich ist.', 'outcome' => ''],
                        ],
                    ],
                ],
            ],
            ...
            'conditions' => [
                ...
                [
                    'titleEn' => 'Address the location question only when relocation looks unlikely',
                    'titleDe' => 'Die Standortfrage nur ansprechen, wenn ein Umzug unwahrscheinlich wirkt',
                    'target' => 'relocation_note',
                    'show' => true,
                    'rules' => [
                        ['start' => 'letter', 'operator' => JevOperator::NoulBelow, 'question' => 'would_relocate', 'expect' => '', 'threshold' => 0.4],
                    ],
                ],
            ],
        ];
